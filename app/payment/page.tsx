...
import { CreditCard, Lock, Loader2, Check, AlertCircle, ArrowRight } from 'lucide-react';
  ...
  const handlePayment = async () => {
    ...
    try {
      const paymentData = {
        ...
        firstName: subscriptionData.firstName || userInfo.fullName?.split(' ')[0] || '',
        lastName: subscriptionData.lastName || userInfo.fullName?.split(' ').slice(1).join(' ') || '',
        membershipType: subscriptionData.subscriptionType,
        billingFrequency: subscriptionData.billingFrequency,
        amount: subscriptionData.amount,
        registrationId: subscriptionData.registrationId || userInfo.registrationId || userInfo.id,
        ...
        >
          <div className="bg-linear-to-r from-[#01311B] to-[#024d2f] text-white py-8 px-6 sm:px-8">
            <h1 className="text-3xl font-bold text-center">
              {subscriptionData.isChangeSubscription ? 'Change Subscription' : 'Complete Your Payment'}
            </h1>
            <p className="text-center text-gray-200 mt-2">Secure payment via Paystack</p>
          </div>

          <div className="p-6 sm:p-8">
            {subscriptionData.isChangeSubscription && subscriptionData.currentSubscriptionType && (
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center gap-3">
                  <AlertCircle className="h-5 w-5 text-blue-600" />
                  <div>
                    <p className="font-medium text-blue-900">Changing Subscription</p>
                    <p className="text-sm text-blue-800 mt-1">
                      You're changing from {getSubscriptionTypeName(subscriptionData.currentSubscriptionType)} to {getSubscriptionTypeName(subscriptionData.subscriptionType)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">{getSubscriptionTypeName(subscriptionData.subscriptionType)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Billing:</span>
                    <span className="font-medium capitalize">{subscriptionData.billingFrequency}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {subscriptionData.billingFrequency === 'monthly' && (
                    <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                      <p className="text-sm text-amber-800">
                        ⚠️ This is a recurring monthly payment. You can cancel anytime from your subscription settings.
                      </p>
                    </div>
                  )}
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Secure payment processing via Paystack. Supports all major credit/debit cards and bank transfers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium text-blue-900">100% Secure Payment</p>
                    <p className="text-sm text-blue-800 mt-1">
                      Your payment information is encrypted and never stored on our servers. Paystack is PCI DSS compliant.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                We're setting up your payment and redirecting you to Paystack for secure payment.
              </p>
